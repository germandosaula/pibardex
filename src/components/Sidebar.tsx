...
interface SidebarProps {
  className?: string;
  activeView: 'play' | 'collection' | 'store';
  onViewChange: (view: 'play' | 'collection' | 'store') => void;
}
    ...
    <>
      <div className={`bg-gradient-to-b from-gray-900/95 via-red-900/80 to-gray-900/95 backdrop-blur-xl border-r border-red-500/20 shadow-2xl ${className}`}>
        <div className="flex flex-col h-full items-center py-6 px-3">
          ...
          {/* Navigation Icons mejorados - Solo si está autenticado */}
          {isAuthenticated && (
            ...
            <div className="mb-6">
              <div className="relative group">
                <button 
                  ...
                  className="relative flex items-center justify-center w-14 h-14 rounded-2xl transition-all duration-300 transform bg-gradient-to-br from-red-500/30 to-purple-600/30 text-red-400 hover:from-red-500/40 hover:to-purple-600/40 hover:text-red-300 hover:scale-105 shadow-lg shadow-red-500/25"
                >
