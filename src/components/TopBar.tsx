...
import { Search, Bell, Settings, User, Coins } from 'lucide-react';
...
export default function TopBar({ className = "" }: TopBarProps) {
  ...
  const [coins] = useState(1250); // Simulando monedas del usuario
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Nivel 15 • Coleccionista</p>
          </div>
        </div>
